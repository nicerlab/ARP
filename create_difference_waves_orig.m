...
outdir = 'C:\Patricia\CARLETON\EXPERIMENTS\LED\2_PROCESSED_DATA\4_ERP\CNT_NEWEV2S\Results\Difference_Waves';% output directory
...
for s=1:numel(subjects)
  ...
  outpath = [outdir subj '/']; 
       ...
       B_plus_wave = load([outpath 'B_plus_all.txt']);
       B_letterH_wave = load([outpath 'B_letterH_all.txt']);
